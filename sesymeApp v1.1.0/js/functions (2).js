...
function sendEmail()
{
	...
	$.ajax(
	{
		url: 'http://localhost:8080/projects/sesyme-web/sesymeApp v1.1.0/includes/email.php',
		method: 'POST',
		...
		data: {report: report, description: description, email: sessionStorage.getItem("user_id")}
	}).then(function(data)
	{
		console.log(data);
